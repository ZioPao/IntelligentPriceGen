...
- Items with category Skill Book should be valued higher than $100. For example, Vol.1 should be $500, then Vol.2 should be $1000, then Vol.3 should be $1500, and so on.
...
- Random stuff shouldn't be valued too high, such as Vehicle Parts, Food utensils, etc.
...
llm = LmmWorker(LmmEnum.CapybaraHermes, grammar=grammar)
