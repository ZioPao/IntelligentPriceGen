...
from examples_no_tag import examples, OutputJsonData
import json
import tqdm
...
#model_path = "F:/models/llm/gguf/solar-10.7b-instruct-q5_k_m.gguf"
...
Format the output data as such: [{{'price' : integer}}].
...
while i < len(data):
    ...
    if not isFound:
        ...
        #t = similar_prompt.format(prevData="")
